...
def translate(sentence: str):
    # Define the device (CPU or GPU), tokenizers, and model
...
translate(sys.argv[1] if len(sys.argv) > 1 else "I aim to create intelligent machines for seamless human collaboration, prioritizing AI, ML, and robotics.")